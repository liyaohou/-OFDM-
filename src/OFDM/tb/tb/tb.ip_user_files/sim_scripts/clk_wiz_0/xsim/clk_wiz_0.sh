...
#
# Script generated by Vivado on Sat Nov 02 00:45:23 +0800 2024
...
simulate()
{
  xsim clk_wiz_0 -key {Behavioral:sim_1:Functional:clk_wiz_0} -tclbatch cmd.tcl -protoinst "protoinst_files/ofdm_tx.protoinst" -log simulate.log
}
