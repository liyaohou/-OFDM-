...
#                script (type 'ofdm_tx.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ofdm_tx xil_defaultlib.glbl -o ofdm_tx_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ofdm_tx_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ofdm_tx_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ofdm_tx_simv.daidir vcs_lib c.obj)
