...
#
# Script generated by Vivado on Sun Nov 10 17:09:18 +0800 2024
...
#
# Usage        : ofdm_tx.sh
#                ofdm_tx.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ofdm_tx.sh [-reset_run]
#                ofdm_tx.sh [-reset_log]
#                ofdm_tx.sh [-help]
#
...
# script info
echo -e "ofdm_tx.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ofdm_tx.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L util_vector_logic_v2_0_2 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ofdm_tx xil_defaultlib.ofdm_tx xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ofdm_tx -key {Behavioral:sim_1:Functional:ofdm_tx} -tclbatch cmd.tcl -protoinst "protoinst_files/ofdm_tx.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="F:/AppData/Xilinx/Vivado/2023.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ofdm_tx.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ofdm_tx.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ofdm_tx.sh [-help]\n\
Usage: ofdm_tx.sh [-step]\n\
Usage: ofdm_tx.sh [-lib_map_path]\n\
Usage: ofdm_tx.sh [-reset_run]\n\
Usage: ofdm_tx.sh [-reset_log]\n\
Usage: ofdm_tx.sh [-keep_index]\n\
Usage: ofdm_tx.sh [-noclean_files]\n\n\
