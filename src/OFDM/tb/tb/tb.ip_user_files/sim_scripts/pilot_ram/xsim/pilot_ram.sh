...
#
# Script generated by Vivado on Fri Nov 01 22:36:08 +0800 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : pilot_ram.sh
...
#
# Usage        : pilot_ram.sh
#                pilot_ram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                pilot_ram.sh [-reset_run]
#                pilot_ram.sh [-reset_log]
#                pilot_ram.sh [-help]
#
...
# script info
echo -e "pilot_ram.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./pilot_ram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot pilot_ram xil_defaultlib.pilot_ram xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim pilot_ram -key {Behavioral:sim_1:Functional:pilot_ram} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb pilot_ram.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./pilot_ram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: pilot_ram.sh [-help]\n\
Usage: pilot_ram.sh [-step]\n\
Usage: pilot_ram.sh [-lib_map_path]\n\
Usage: pilot_ram.sh [-reset_run]\n\
Usage: pilot_ram.sh [-reset_log]\n\
Usage: pilot_ram.sh [-keep_index]\n\
Usage: pilot_ram.sh [-noclean_files]\n\n\
