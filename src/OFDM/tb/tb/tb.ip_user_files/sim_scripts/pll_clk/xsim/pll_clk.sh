...
#
# Script generated by Vivado on Sat Nov 02 21:40:03 +0800 2024
...
#
# Usage        : pll_clk.sh
#                pll_clk.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                pll_clk.sh [-reset_run]
#                pll_clk.sh [-reset_log]
#                pll_clk.sh [-help]
#
...
# script info
echo -e "pll_clk.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./pll_clk.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot pll_clk xil_defaultlib.pll_clk xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim pll_clk -key {Behavioral:sim_1:Functional:pll_clk} -tclbatch cmd.tcl -protoinst "protoinst_files/ofdm_tx.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb pll_clk.wdb xsim.dir libdpi.so)
...
Usage: pll_clk.sh [-step]\n\
Usage: pll_clk.sh [-lib_map_path]\n\
Usage: pll_clk.sh [-reset_run]\n\
Usage: pll_clk.sh [-reset_log]\n\
Usage: pll_clk.sh [-keep_index]\n\
